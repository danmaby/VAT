 ...
 * @return void
 */
function woo_projects_archive_description_wrap() {
	?>
 ...
 * @return void
 */
function woo_projects_archive_description_wrap_close() {
	?>
		</div>
	<?php
}
...
/**
 * Opens the projects loop wrap
 * @return  void
 */
function woo_projects_product_loop_wrap_open() {
	?>
...
/**
 * Closes the projects loop wrap
 * @return  void
 */
function woo_projects_product_loop_wrap_close() {
	?>
