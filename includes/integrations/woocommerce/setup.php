...
if ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '2.3', '>=' ) ) {
	add_filter( 'woocommerce_add_to_cart_fragments', 'woo_wc_header_add_to_cart_fragment' );
} else {
...
add_action( 'woocommerce_before_subcategory_title',			'woo_wc_subcat_title_wrap' );
add_action( 'woocommerce_after_subcategory_title',			'woo_wc_subcat_title_wrap_close' );
