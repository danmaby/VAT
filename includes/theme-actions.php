...
add_filter( 'body_class', 'woo_add_slider_autoheight_class' );
function woo_add_slider_autoheight_class( $classes ) {
	if ( is_home() && apply_filters( 'woo_homepage_slider_fullscreen', true ) ) {
