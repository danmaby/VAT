...
?>
    ...
    <div id="content" class="content-container">
		...
		?>
		<section class="testimonials content-container-fullwidth-nopadding">
			<h1 class="section-title"><?php _e( 'You\'re in good company...', 'woothemes' ); ?></h1>
		...
		<?php if ( class_exists( 'Woothemes_Our_Team' ) && apply_filters( 'upstart_homepage_our_team', true ) ) : ?>
			<section class="meet-the-team content-container-fullwidth-nopadding">
				...
				<?php
					$our_team_limit = apply_filters( 'upstart_homepage_our_team_limit', $limit = 8 );
					echo do_shortcode( '[woothemes_our_team limit="' . $our_team_limit  . '"]' );
				?>
			</section>
		<?php endif; ?>
